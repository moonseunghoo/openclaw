...
## Description
Provides a comprehensive daily or real-time briefing of global financial markets. This skill analyzes major indices, economic indicators, and market-moving news through a two-layer approach: high-level global dynamics and deep-dive local intelligence to deliver professional, actionable insights.
...
### 1. Data Gathering
- **Time-Sensitive Retrieval**: **[CRITICAL] Always use the current execution date/time as the absolute reference point for all searches.** If web search results return data from a different year (e.g., 2024 instead of 2026), it is considered "stale" or "historical". In such cases, you MUST refine your search query to include the current year (e.g., "May 2026") or look for more recent sources to ensure you are not reporting on past years' data.
